...
app = Celery('naive_tasks',
    broker="amqp://celery_user:password@localhost:5672/celery_vhost"
)

CELERY_CONFIG = {
    "CELERY_RESULT_BACKEND": "amqp://celery_user:password@localhost:5672/celery_vhost"
}
